...
const PROXY_BASE_URL = "https://app-to-extract-holdings-stable.vercel.app/api/extract-data";
const BULK_API_URL = "https://app-to-extract-holdings-stable.vercel.app/api/extractinsight";
